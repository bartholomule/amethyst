...
namespace amethyst
{
  ...
  public:
    ...
    inline vector3<T> u() const
    {
      return my_basis.get_u();
    }
    inline vector3<T> v() const
    {
      return my_basis.get_v();
    }
    inline vector3<T> w() const
    {
      return my_basis.get_w();
    }
    inline point3<T>  o() const
    {
      return my_origin;
    }
