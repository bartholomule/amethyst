...
/*
  $Id: gen-class-lgpl.cpp,v 1.1 2003/09/16 09:04:04 kpharris Exp $
 */
...
static const string PackageText = "Part of \"Many Games\" - A nearly infinitely expandable gaming framework";
...
void RemoveSwitches(int& argc, char** argv, string& munged_class, string& parent, string& file_base)
{
  ...
  while ( 1 )
  {
    ...
    int option_index = 0;
    c = getopt_long (argc, argv, "o:p:hv", long_options, &option_index);
