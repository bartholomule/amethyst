/*
 * $Id: intersection_info.hpp,v 1.1 2004/02/09 00:39:20 kpharris Exp $
 *
...
#if       !defined(__AMETHYST__INTERSECTION_INFO_HPP__)
#define            __AMETHYST__INTERSECTION_INFO_HPP__
...
#endif /* !defined(__AMETHYST__INTERSECTION_INFO_HPP__) */
