/*
 * $Id: unit_line2.hpp,v 1.1 2004/02/08 23:59:42 kpharris Exp $
 *
...
#if       !defined(__AMETHYST__UNIT_LINE2_HPP__)
#define            __AMETHYST__UNIT_LINE2_HPP__
...
#endif /* !defined(__AMETHYST__UNIT_LINE2_HPP__) */
