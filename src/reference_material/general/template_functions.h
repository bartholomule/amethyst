...
{
  // Note (20030917): This could be replaced with a ostream iterator and
  // std::copy... 
...
// templated function).
//
// NOTE (20030917) std::max in (utility?, algorithm?), can be used instead.
template <class T>
...
// templated function).
//
// NOTE (20030917) std::min in (utility?, algorithm?), can be used instead.
template <class T>
